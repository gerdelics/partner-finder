    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 to-slate-800 p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 sm:p-10 flex flex-col items-center gap-6 w-full max-w-sm">
        <div className="flex flex-col items-center gap-3">
          <div className="w-16 h-16 bg-blue-700 rounded-2xl flex items-center justify-center text-white text-2xl font-bold shadow-lg">
            PF
          </div>
          <h1 className="text-2xl font-bold text-gray-900">PartnerFinder</h1>
          <p className="text-gray-500 text-sm text-center">
            Fuvarozási partner nyilvántartó
          </p>
        </div>
        ...
        <p className="text-xs text-gray-400 text-center">
          Csak az Ön saját partneradatai lesznek tárolva.
        </p>
      </div>
    </div>
  )
