...
export function PartnerModal({ mode, partner, onSave, onClose }: PartnerModalProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-40 flex items-start sm:items-center justify-center bg-black/50 p-0 sm:p-4"
      onClick={e => { if (e.target === e.currentTarget) onClose() }}
    >
      <div className="bg-white w-full sm:rounded-xl sm:max-w-2xl shadow-2xl flex flex-col max-h-screen sm:max-h-[90vh]">
